        ...
        <div class="main-content">
            <div class="form-wrapper">
              <ion-card class="course">
                ...
                <ion-card-header>
                  <ion-card-title class="regcourse">Course Registration</ion-card-title>
                </ion-card-header>
                ...
                <ion-card-content>
                  ...
                  <ion-button expand="block" class="ion-regCourse" @click="handleRegister">
                    Register
                  </ion-button>
...
const handleRegister = async () => {
  ...
  try {
    ...
    Swal.fire('Error', 'Failed to register the course.', 'error');
  }
};
</script>
...
ion-button.ion-regCourse::part(native){
  background: #05044D;
}

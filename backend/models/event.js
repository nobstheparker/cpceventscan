class Event {
  ...
  async create(eventData) {
    ...
    // Insert default attendance controls
    const attendanceQuery = `
      INSERT INTO attendance_controls (
        event_id, morning_time_in, morning_mid_event, morning_time_out,
        afternoon_time_in, afternoon_mid_event, afternoon_time_out, feedback_form
